            ...
            <ul class="sidebar--items">  
                ...
                <li>
                    <a href="{{ url('') }}" id="active--link">
                        <span class="icon icon-4"><i class="ri-file-user-line"></i></span>
                        <span class="sidebar--item" style="white-space: nowrap;">Data Pegawai</span>
                    </a>
                </li> 
                <li>
                    <a href="{{ url('') }}">
        ...
        <div class="main--content">
            <div class="overview">
                <div class="title">
                   ...
                   <button class="add"><i class="ri-add-line">Tambahkan Pegawai</i></button>
                </div>
                <div class="table">
                    <table>
                        <thead>
